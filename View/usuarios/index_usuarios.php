<center>
    ...
    <form class="form-inline my-2 my-lg-0">
        <input type='search' class='form-control' onkeyup="myFunction1(this)" name="keyword" id='my-search4' placeholder='¿Qué estás buscando?' style='width:30%;'>
    ...
    <table id='example-table4' class="table table-bordered table-striped border border-4" border=0 cellpadding=0 cellspacing=0 width=971 style='border-collapse:
        ...
        <tbody>
            ...
            while ($datos = $sql->fetch_object()) { ?>
                <tr>
                    ...
                    <td style="">
                        <a href="View/usuarios/numero_ingresos.php?usuario=<?= $datos->user_login ?>" class="btn btn-small btn-warning"><i class="fa-solid fa-eye" style="color:#FFFFFF; "></i></a>
                        <a href="View/usuarios/eliminarUsuarios.php?usuario=<?= $datos->user_login ?>" class="btn btn-small btn-danger"><i class="fa-solid fa-user-slash" style="color:#FFFFFF; "></i></a>
                    </td>
                </tr>
            <?php
            }
