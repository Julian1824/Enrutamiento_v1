             <center>
                 ...
                 <form class="form-inline my-2 my-lg-0">
                     <input type='search' class='form-control' onkeyup="myFunction1(this)" name="keyword" id='my-search1' placeholder='¿Qué estás buscando?' style='width:30%;'>
                 ...
                 <table id='example-table1' class="table table-bordered table-striped border border-4" border=0 cellpadding=0 cellspacing=0 width=827 style='border-collapse:
                     ...
                     <thead class="text-white">
                         ...
                         <tr height=20 style='height:15.0pt'>
                             <td height=20 class=xl72 width=644 style='height:15.0pt;width:483pt;background-color: #198754'>Pregunta
                                 frecuente
                             </td>
                             <td class=xl72 width=183 style='border-left:none;width:137pt;background-color: #198754'>Programa a
                                 transferir
                                 <span style='mso-spacerun:yes'> </span>
                             </td>
                             <td class=xl72 width=183 style='border-left:none;width:137pt;background-color: #198754'>Acciones
                             </td>
                         </tr>
                     </thead>
                     <tbody>
